         ...
         '>
            ...
            <div className='w-full flex flex-col items-start justify-between mt-4'>
                ...
                <div className='mt-2 w-full flex items-center justify-between'>
                    ...
                    <Link href={github} target="_blank" className='ml-4 rounded-lg text-lg font-semibold underline'>Visit</Link>
                    <Link href={github} target="_blank" className='mr-4 w-8'><GithubIcon /></Link>
                </div>
            </div>
