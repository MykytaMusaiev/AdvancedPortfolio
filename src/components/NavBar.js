...
import { GithubIcon, LinkedInIcon, MoonIcon, SunIcon, TelegramIcon, TwitterIcon } from './Icons'
...
const NavBar = () => {
    ...
    return (
        <header
            ...
            dark:text-light z-10 lg:px-16 md:px-12 sm:p-8
            '
        >
            {/* TODO fix burger crash on mobile ver */}
            ...
            {/* TODO перевірити що хрестик зрізається*/}
