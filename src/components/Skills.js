    ...
    return (
        <>
            ...
            >
                ...
                <Skill name="Web Design" x="0vw" y="-24vw" />
                ...
                <Skill name="Styled Components" x="15vw" y="15vw" />

                <Skill name="Github" x="-10vw" y="20vw" /> */}
                <Skill name="HTML5, CSS3, JS(ES6+)" x="-2vw" y="-11vw" />
                <Skill name="ReactJS" x="0vw" y="-4vw" />
                <Skill name="NextJS" x="4vw" y="3vw" />
                <Skill name="TypeScript" x="-15vw" y="-5vw" />
                <Skill name="TailwindCSS" x="16vw" y="-5vw" />
                <Skill name="RTK/RTK Query" x="16vw" y="10vw" />
                <Skill name="Jest / React Testing Library" x="-20vw" y="2vw" />
                <Skill name="ESLint & Prettier" x="21vw" y="1vw" />
                <Skill name="Git / pnpm / Husky" x="15vw" y="-17vw" />
                <Skill name="Agile Methodology" x="-18vw" y="9vw" />
                <Skill name="Jira" x="0vw" y="10vw" />
                <Skill
                    name="Cross-functional Collaboration"
                    x="2vw"
                    y="16vw"
                />
                {/* <Skill name="Effective Code Review" x="-10vw" y="20vw" />
                <Skill name="Web Accessibility" x="-10vw" y="20vw" />
                <Skill name="Performance Optimization" x="-10vw" y="20vw" /> */}
                {/* <Skill name="Github" x="-10vw" y="20vw" /> */}
            </div>
        </>
    );
